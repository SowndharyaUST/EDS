import { div, span, input, label, img } from "../../scripts/dom-helpers.js";

async function getProductData(stateCode, cityCode) {
  const baseUrl =
    "https://dev1.heromotocorp.com/content/hero-commerce/in/en/products/product-page/practical/jcr:content.product.practical.splendor-plus";
